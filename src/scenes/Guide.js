class Guide extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.bitmapText(centerX, game.config.height/4, '8-bit', 'Use the arrow keys to move ', 20).setOrigin(0.5);
        this.add.bitmapText(centerX, game.config.height/3.5, '8-bit', 'Up arrow: dig up, Down arrow: dig down', 20).setOrigin(0.5);
